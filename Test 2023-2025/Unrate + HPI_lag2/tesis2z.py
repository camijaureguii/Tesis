...
#   Train: origen 2007 a 2022 inclusive
#   Test:  origen 2023, 2024 y 2025
# ══════════════════════════════════════════════════════════════════════════════
...
panel = panel[panel["anio"].between(2007, 2026)].copy()
...
# ── MATRIZ 2022 (base de comparación para proyecciones — último año de train) ──
N_2022 = conteos_por_anio[2022]
P_2022 = N_2022.div(N_2022.sum(axis=1), axis=0).fillna(0)

print("\n" + "="*60)
print("MATRIZ 2022  (base de comparación para proyecciones macro)")
print("="*60)
