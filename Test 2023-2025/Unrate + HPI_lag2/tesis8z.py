...
# Matriz 2022 como comparación estática (reconstruida desde panel cohort)
...
print(f"  Solo 2022, Proyectadas 2023/2024/2025")
...
for anio in [2023, 2024, 2025]:
    ...
    # Matrices del año: solo 2022 y proyectada
    matrices_anio = {**modelos, "Proyectada": matrices_pit.get(anio, P_2022)}
...
print("\n" + "="*55)
print("MÉTRICAS AGREGADAS POR MODELO (promedio 2023-2025)")
print("="*55)
print(f"{'Modelo':<14} {'MAE rel.':>12} {'% veces en IC':>15}")
print("-"*55)
for modelo in ["Solo 2022", "Proyectada"]:
